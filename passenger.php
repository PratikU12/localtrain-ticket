				...
				<div class="container-fluid">
					<form class="form-horizontal" role="form" id="form-pass">
					  ...
					  <div class="form-group">
					    ...
					    <input type="text" class="form-control" id="cont" placeholder="Enter Phone no" required="" autocomplete="off">
					  </div>
					  <div class="form-group">
					    <label for="">Email ID:</label>
					    <input type="text" class="form-control" id="address" placeholder="Enter Email ID" required="" autocomplete="off">
					  </div>
					<br />
					<?php 
