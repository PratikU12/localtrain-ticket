		...
		<div class="panel panel-default">
			<div class="panel-body">
			 ...
			 <div class="panel panel-success">
			 	...
			 	<div class="panel-body">
			 		<strong>
			 			...
			 			<i>Estimated Arrival Time: 11:00AM</i><br />
			 			<strong>
			 ...
			 <div class="panel panel-success">
			 	...
			 	<strong>Phone No:</strong> <?= $bookByInfo['book_contact']; ?><br />
			 	<strong>Email Address:</strong> <?= $bookByInfo['book_address']; ?><br />
			 	</div>
			 </div>
				<div class="container-fluid">
				<strong>
				<span class="glyphicon glyphicon-user" aria-hidden="true"></span>
				PASSENGERS - Store booking ID for further reference</strong>
					<table id="myTable-party" class="table table-bordered table-hover" cellspacing="0" width="100%">
						    ...
						    <strong>- Booking ID: <?= $tracker; ?></strong>
						   </table>
						   <center>
